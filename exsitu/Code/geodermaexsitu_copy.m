...
plot(3.28, 5.74, 'dg', 'markersize',12)
plot(3.68, 5.78, 'or', 'markersize',12)
plot(3.12, 6.85, 'xb', 'markersize',12)
plot(3.74, 4.42, '*k', 'markersize',12)
plot(2.96, 3.78, '+m', 'markersize',12)
xlim([0 10]); ylim([0 20])
legend('Raw',  'Smooth', '1^s^t SGD', '2^n^d SGD', ...
    'Location','SouthEast')
...
plot(1.41, 3.25, 'dg', 'markersize',12)
plot(1.50, 2.51, 'or', 'markersize',12)
plot(1.23, 2.34, 'xb', 'markersize',12)
plot(0.64, 0.73, '*k', 'markersize',12)
plot(0.63, 0.84, '+m', 'markersize',12)
xlim([0 5]); ylim([0 12])
legend('Raw',  'Smooth', '1^s^t SGD', '2^n^d SGD', ...
    'Location','SouthEast')
...
plot(1.20, 1.58, 'dg', 'markersize',12)
plot(1.29, 2.24, 'or', 'markersize',12)
plot(0.99, 1.46, 'xb', 'markersize',12)
plot(1.06, 1.48, '*k', 'markersize',12)
plot(0.99, 1.09, '+m', 'markersize',12)
xlim([0 3]); ylim([0 7])
legend('Raw',  'Smooth', '1^s^t SGD', '2^n^d SGD', ...
    'Location','SouthEast')
...
text(556,tt(25),'\leftarrow SOM ', 'HorizontalAlignment','left')
text(674,tt(46),'\leftarrow SOM (best) ', 'HorizontalAlignment','left')
text(585,tt(30),'SOM \rightarrow', 'HorizontalAlignment','right')
