...
plot(1.81, 3.48, 'db', 'markersize',12)
...
plot([6,0], [0,6], '.-.')
plot(1.38, 2.14, 'db', 'markersize',12)
...
text(421,tt(2),'\leftarrow Carbon ', 'HorizontalAlignment','left')
text(1747,tt(251),'\leftarrow Carbon (best) ', 'HorizontalAlignment','left')
text(1605,tt(220),'Carbon \rightarrow  ', 'HorizontalAlignment','right')
text(590,tt(31),'\leftarrow Carbon ', 'HorizontalAlignment','left')
text(722,tt(55),'\leftarrow Carbon ', 'HorizontalAlignment','left')
